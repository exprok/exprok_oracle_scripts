declare
  sql_id_  varchar2(20) := '76341thpcvqbc'; -- вписать значение sql_id тут
  nums_iterations integer :=1;    -- число повторений через паузу, если 1 то без задержек
  pause_  integer :=2;         --- длина паузы между повторениями
