...
begin
    dbms_scheduler.open_window(window_name => 'WIN_DAY',duration => '+000 07:45:00' );
end;
...
begin
     dbms_scheduler.create_window(window_name => 'WIN_NIGHT',
                                  resource_plan => 'P_NIGHT',
                                  schedule_name => 'SCHED_NIGHT',
                                  duration => '+000 14:00:00',
                                  window_priority => 'HIGH',
                                  comments => 'NIGHT''S WINDOW');
